...
- [E2E Tests for Slack Channel in One Day](https://startaitools.com/posts/58-e2e-tests-slack-channel-launch-one-day/) — how the test suite this sprint relied on got built
- [Twelve PRs in a Security Sprint with Pregame Overhaul](https://startaitools.com/posts/twelve-prs-security-sprint-pregame-overhaul/) — an earlier multi-PR security batch run with the same batching discipline
